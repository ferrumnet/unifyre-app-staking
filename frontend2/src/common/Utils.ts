...
export const Networks = ['ETHEREUM', 'RINKEBY', 'RINKEBY', 'BSC', 'BSC_TESTNET', 'POLYGON', 'MUMBAI_TESTNET', 'AVAX_TESTNET','AVAX_MAINNET'
,'MOON_MOONRIVER', 'HARMONY_TESTNET_0','HARMONY_MAINNET_0','FTM_TESTNET','FTM_MAINNET','SHIDEN_TESTNET','SHIDEN_MAINNET']
